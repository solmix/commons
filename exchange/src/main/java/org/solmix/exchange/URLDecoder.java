...
public class URLDecoder {
    ...
    /**
     * Construct a new URLDecoder with default buffer sizes.
     *
     * @param charsetDecoder Charset to decode bytes into chars with
     * @see URLDecoder#PercentDecoder(CharsetDecoder, int, int)
     */
    public URLDecoder(CharsetDecoder charsetDecoder) {
     ...
     */
    public URLDecoder(CharsetDecoder charsetDecoder, int initialEncodedByteBufSize,
