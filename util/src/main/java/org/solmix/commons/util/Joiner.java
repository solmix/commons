...
public class Joiner {
    ...
    public Joiner skipNulls() {
        return new Joiner(this) {
            public <A extends Appendable> A appendTo(A appendable, Iterator<?> parts)
                    throws IOException {
                assertNotNull(appendable, "appendable");
    ...
    CharSequence toString(Object part) {
        assertNotNull(part);  // assertNotNull for GWT (do not optimize).
    ...
    public static final class MapJoiner {
        ...
        private MapJoiner(Joiner joiner, String keyValueSeparator) {
            this.joiner = joiner; // only "this" is ever passed, so don't assertNotNull
            this.keyValueSeparator = assertNotNull(keyValueSeparator);
        }
